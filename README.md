...
| <img src="preview_3.png" width="400" alt="New Task form with calendar, summary, description, due date, and category fields"> | <img src="preview.png" width="400" alt="Settings screen with calendar rows, CalDAV server connect form, and debug log console"> |
